...
define('DB_HOST', 'localhost:3307'); // Wat is het IP adres van de server (127.0.0.1 is de lokae machine) :3307 op thuis pc
define('DB_NAME', 'paard'); // Wat is de database naam
